...
import com.udacity.caraher.emma.project1.data.WeatherDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        long index = db.insert(WeatherContract.LocationEntry.TABLE_NAME, null, values);
        assertTrue(index != -1);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Location Query Validation Failed", c, values);
    ...
    public void testWeatherTable() {
        ...
        // Insert ContentValues into database and get a row ID back
        long index = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, values);
        assertTrue(index != -1);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Error: Weather Query Validation Failed", c, values);
