...
public class Utility {
    ...
    public static boolean isMetric(Context context) {
        ...
        return prefs.getString(context.getString(R.string.pref_unit_key),
                context.getString(R.string.pref_unit_celsius))
                .equals(context.getString(R.string.pref_unit_celsius));
    }
    ...
    static String formatWind(Context context, double windSpeed, double degrees, boolean isMetric) {
        int windFormat;
        ...
        String windText = String.format("%1.0f %s %s", windSpeed, context.getString(windFormat), direction);

        return String.format(context.getString(R.string.format_wind), windText);
    }
    ...
    int getLocationStatus(Context context){
        ...
        return preferences.getInt(context.getString(R.string.pref_location_status_key),
    ...
    static public void resetCurrentLocationStatus(Context context) {
        ...
        preferenceEditor.putInt(context.getString(R.string.pref_location_status_key),
                SunshineSyncAdapter.LOCATION_STATUS_UNKNOWN);
    ...
    public static boolean usingLocalGraphics(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        String sunshineArtPack = context.getString(R.string.pref_art_pack_label);
    ...
    public static String getStringForWeatherCondition(Context context, int weatherId) {
        ...
        if (weatherId >= 200 && weatherId <= 232) {
            ...
            case 962:
                ...
                break;
            default:
                return context.getString(R.string.condition_unknown, Integer.toString(weatherId));
        }
