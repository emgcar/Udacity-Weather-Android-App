...
import com.udacity.caraher.emma.project1.data.WeatherProvider;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                ...
                mContext.getString(R.string.pref_unit_celsius));

        if (unitType.equals(mContext.getString(R.string.pref_unit_fahrenheit))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (!unitType.equals(mContext.getString(R.string.pref_unit_celsius))) {
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(KEY_PARAM, mContext.getString(R.string.appid_key))
                    .build();
