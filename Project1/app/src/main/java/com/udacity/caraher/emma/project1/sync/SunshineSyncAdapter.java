package com.udacity.caraher.emma.project1.sync;
...
import com.udacity.caraher.emma.project1.MainActivity;
import com.udacity.caraher.emma.project1.R;
import com.udacity.caraher.emma.project1.Utility;
import com.udacity.caraher.emma.project1.data.WeatherContract;
import com.udacity.caraher.emma.project1.muzei.WeatherMuzeiSource;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final String ACTION_DATA_UPDATED =
            "com.udacity.caraher.emma.project1.ACTION_DATA_UPDATED";
...
// 60 seconds (1 minute)  180 = 3 hours
    ...
    public void onPerformSync(Account account, Bundle extras, String authority,
        ...
        try {
            ...
            Uri builtUri = uriBuilder
                    ...
                    .appendQueryParameter(APPID_PARAM, getContext().getString(R.string.appid_key))
                    .build();
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            // do we have an error?
            if ( forecastJson.has(OWM_STATUS) ) {
                int errorCode = forecastJson.getInt(OWM_STATUS);
                switch (errorCode) {
    ...
    private void setLocationStatus(Context context, @LocationStatus int locationStatus) {
        ...
        preferenceEditor.putInt(context.getString(R.string.pref_location_status_key), locationStatus);
